  ...
  console.log(users);
    ...
    return (
        <div className='h-screen flex items-center justify-center'>
          <div >
            <h1 className='md:text-4xl text-2xl font-serif text-center'>Welcome Dear Honorable <span className='underline text-green-600'>{users?.role}</span> <br /> <span>{users?.name}</span> </h1>
